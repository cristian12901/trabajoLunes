...
public class VistaApp extends JFrame {
    ...
    public VistaApp() {
        setTitle("Gestión de Notas - Primer Semestre");
        setSize(600, 400);
        ...
        btnIngresar = new JButton("Ingresar Estudiante (Cuadro Flotante)");
        panel1.add(btnIngresar);
        pestañas.addTab("1. Ingresar Datos", panel1);
        ...
        btnPaso3 = new JButton("Paso 3: Incrementar Nota");
